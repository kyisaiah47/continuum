...
import { Users, Check, X, Clock, DollarSign } from "lucide-react"
  ...
  const requests = [
    {
      ...
      amount: "5 DOT",
      duration: "30 days",
      reason: "Customer relationship management and personalized outreach",
    ...
    },
    {
      ...
      companyLogo: "TS",
      fields: ["Full Name", "Email", "Company", "Job Title", "LinkedIn"],
      amount: "8 DOT",
      duration: "60 days",
      reason: "B2B sales and partnership opportunities",
    ...
    },
    {
      ...
      company: "DataCorp",
      companyLogo: "DC",
      fields: ["Email", "Industry Interest"],
      amount: "3 DOT",
      duration: "14 days",
      reason: "Market research and industry trends analysis",
                ...
                <div className="flex gap-8">
                  ...
                  <div className="flex-shrink-0">
                    <div className="h-16 w-16 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center">
                      <span className="text-lg font-light text-primary">{request.companyLogo}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="text-2xl font-light text-white mb-2">{request.company}</h3>
                      ...
                      <div className="text-right">
                        <div className="text-3xl font-light text-primary mb-1">{request.amount}</div>
                        <div className="text-sm text-white/40">for {request.duration}</div>
                      </div>
                    </div>
                    ...
                    {/* Reason */}
                    <div className="mb-6">
                      <p className="text-xs text-white/40 uppercase tracking-[0.15em] mb-2">Reason for Request</p>
                      <p className="text-base text-white/60">{request.reason}</p>
                    </div>

                    {/* Actions */}
                    <div className="flex gap-3">
                      <ButtonPurple className="h-11 px-6 text-sm">
                        <Check className="mr-2 h-4 w-4" />
                        Approve & Earn {request.amount}
                      </ButtonPurple>
                      <button className="h-11 px-6 text-sm rounded-lg border border-white/[0.08] bg-white/[0.03] hover:bg-white/[0.05] text-white/60 hover:text-white transition-all flex items-center gap-2">
                        <X className="h-4 w-4" />
                        Reject
                      </button>
                    </div>
